...
while ($row = $query->fetch_assoc()) {
	...
	$tunj2 = '
		...
		';
	$tunj3 = '
		<span class="input form-control form-control-sm" contenteditable="true" data-old_value="'.$pn['telat'].'"  onBlur="simpankes(this,\'ekskul\',\''.$idp.'\',\''.$bln.'\',\''.$thn.'\')" onClick="highlightEdit(this);">'.$pn['ekskul'].'</span>
		';
	$tunj4 = '

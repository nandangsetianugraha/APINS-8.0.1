          ...
          <div class="section-body">
				  <div class="card">
					<div class="card-header">
					  <h4>Daftar Tema Kelas <?=$ab;?> Semester <?=$smt;?></h4>
					  <div class="card-header-form">
						<button class="btn btn-primary btn-icon" data-toggle="modal" data-target="#tambahTema" id="addTemaModalBtn"><i class="fas fa-calendar-plus"></i> Tambah Tema</button>
              ...
              <form class="form" action="../modul/administrasi/tambahtema.php" method="POST" id="createTemaForm">
                        <div class="modal-body">
							<div class="form-group form-group-default">
								...
								<input id="kelas1" type="text" readonly class="form-control" value="<?php echo $kelas;?>">
							</div>
							<div class="form-group form-group-default">
								<label>Semester</label>
								<input type="hidden" id="smt" name="smt" class="form-control" value="<?php echo $smt;?>">
								<input id="smt1" type="text" readonly class="form-control" value="<?php echo $smt;?>">
							</div>
							<div class="form-group form-group-default">
								<label>Tema</label>

<?php
 ...
 include '../function/db_connect.php';
	...
	$smt=$_GET['smt'];
		...
		$namafilenya="Rekapitulasi Nilai Raport Kelas ".$kelas.".pdf";
		$pdf=new exFPDF('L','mm',array(330,215));
		$pdf->AddPage(); 
		$pdf->SetFont('helvetica','',12);

		$table2=new easyTable($pdf, 2);
		$table2->easyCell('REKAPITULASI NILAI RAPORT KELAS '.$kelas,'colspan:2;align:C;font-style:B');
		$table2->printRow();
		...
		$table3=new easyTable($pdf, '{120, 18,18,18,18,18,18,18,18,18,18,18,17,17,12}','align:L;border:1');
